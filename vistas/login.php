...
<body>
  <div class="">
     <div style="padding: 10px;">
         <button class="btn btn-primary"> <a href="vistas/login_modo_privilegiado.php" style="color: white; align-content: right;text-decoration: none;">Ingresar en modo privilegiado</a></button>
     </div>
   <div class="container">
    <div class="row">
