...
$sql="INSERT INTO `producto`( `codigo_producto`,`imagen_producto`, `Nombre_producto`, `Descripcion_producto`, `Precio`,`Precio_dolares`,`cantidad_total`,`cantidad_inicial`) VALUES ('$codigo','$imagen','$nombre_producto','$descripcion','$precio','$precio_dolares','$cantidad_total','$cantidad_inicial')";
